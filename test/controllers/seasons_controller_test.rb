...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post seasons_url, params: { season: { end_time: @season.end_time, name: @season.name, start_time: @season.start_time } }
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { end_time: @season.end_time, name: @season.name, start_time: @season.start_time } }
